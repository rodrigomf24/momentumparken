            ...
            <div class="vertical_logo_wrapper">
				...
				<div class="q_logo_vertical">
					<a href="<?php echo home_url('/'); ?>">
						<img class="normal" src="<?php echo '/wp-content/uploads/2015/06/momentumparken-logo.png'; ?>" alt="Logo"/>
                ...
                <?php } ?>
					<div class="header_inner_left">
						...
						<div class="logo_wrapper">
							...
							?>
							<div class="q_logo"><a href="<?php echo home_url('/'); ?>"><img class="normal" src="<?php echo '/wp-content/uploads/2015/06/momentumparken-logo.png'; ?>" alt="Logo"/><img class="light" src="<?php echo $logo_image_light; ?>" alt="Logo"/><img class="dark" src="<?php echo $logo_image_dark; ?>" alt="Logo"/><img class="sticky" src="<?php echo $logo_image_sticky; ?>" alt="Logo"/><?php if($enable_popup_menu == 'yes'){ ?><img class="popup" src="<?php echo $logo_image_popup; ?>" alt="Logo"/><?php } ?></a></div>
