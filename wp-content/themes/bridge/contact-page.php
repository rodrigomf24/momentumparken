						...
						<div class="column2">
							<div class="column_inner">
								<div class="contact_form">
									<h5><?php if($qode_options_proya['contact_heading_above'] != "") { echo $qode_options_proya['contact_heading_above'];  } else { ?><?php _e('KONTAKT OSS', 'qode'); ?><?php } ?></h5>
									<form id="contact-form" method="post" action="">
										<div class="two_columns_50_50 clearfix">
											<div class="column1">
												<div class="column_inner">
													<input type="text" class="requiredField" name="fname" id="fname" value="" placeholder="<?php _e('Fornavn *', 'qode'); ?>" />
													
												</div>
											</div>
											<div class="column2">
												<div class="column_inner">
													<input type="text" class="requiredField" name="lname" id="lname" value="" placeholder="<?php _e('Etternavn *', 'qode'); ?>" />
												</div>
											</div>
										</div>
										<?php if ($hide_contact_form_website == "yes") { ?>
											<input type="text" class="requiredField email" name="email" id="email" value="" placeholder="<?php _e('Epost *', 'qode'); ?>" />
										...
										<div class="two_columns_50_50 clearfix">
											...
											<div class="column2">
												<div class="column_inner">
													<input type="text" name="website" id="website" value="" placeholder="<?php _e('Hjemmeside', 'qode'); ?>" />	
												</div>
											</div>
										</div>
										<?php }?>
										<textarea name="message" id="message" rows="10" placeholder="<?php _e('Beskjed', 'qode'); ?>"></textarea>
										...
										<span class="submit_button_contact">
											<input class="qbutton" type="submit" value="<?php _e('SENDE', 'qode'); ?>" />
										</span>
									</form>	
								</div>
    ...
    $j('form#contact-form').submit(function(){
        ...
        if(!hasError){
			...
			if(html == "success"){
				...
				$j("form#contact-form").before("<div class='contact-success'><strong><?php _e('Takk!', 'qode'); ?></strong><p><?php _e('Din e-post er sendt. Vi vil kontakte deg så snart som mulig.', 'qode'); ?></p></div>");
